...
// DEPRECATED: This file is deprecated and will be removed in a future release. The skills feature is being removed to simplify the app and focus on core features. If you want to add skills back, you can copy this file to your own project and update it as needed.
//
