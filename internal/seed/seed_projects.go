	...
	projects := []model.Project{
		{
			...
			SortOrder:    1,
			Featured:     true,
			LiveURL:      "https://github.com/wecrazy/service-platform/blob/main/preview/README.MD",
		...
		{
			Title:        "Middleware Pending Error - TA",
			Slug:         "middleware-pending-error-ta",
		...
		},
		{
			...
			SortOrder:    10,
			Featured:     true,
			LiveURL:      "https://github.com/wecrazy/rust_project/blob/main/README.md",
		...
		},
		{
			...
			Description:  "Internal system for validating and monitoring technician visit data, enabling error/pending data handling, task review, and performance tracking integrated with Odoo ERP.",
		...
		},
		{
			Title:        "Reporting",
			Slug:         "reporting",
			Description:  "Client and internal reports generated using Go. The system processes structured data and produces well-formatted Excel reports using customizable templates, supporting various report types such as tickets, inventory, and performance analytics.",
			Tags:         "Go, Excel, Pivot",
			Status:       "published",
			SortOrder:    14,
			Featured:     true,
		...
		},
		{
			Title:        "Portfolio",
			Slug:         "portfolio",
			Description:  "Personal portfolio website built with Go, Fiber v3, HTMX and GORM. It showcases the projects, tech stack, and experiences in a clean and modern design.",
		...
		},
		{
			Title:        "Web Panel",
			Slug:         "web-panel",
			LongDesc:     "Web Panel is a modern role-based admin dashboard built with Go (Gin). The interface adapts dynamically based on the user’s role. It provides chatbot setup and management features. It includes reporting and analytics for system insights. It allows user, role, and permission configuration. It offers a centralized dashboard for activity and overview. It is built using HTML, CSS, JavaScript, and Bootstrap. It is designed for scalable and flexible admin systems.",
			Tags:         "Go, Gin, Bootstrap, GORM, Role-Based Access Control, Chatbot, Dashboard, Reporting",
			Status:       "published",
			SortOrder:    16,
			Featured:     true,
			LiveURL:      "https://146.196.106.202:3420/login",
			RepoURL:      "https://github.com/wecrazy/web_panel",
			ThumbnailURL: "https://raw.githubusercontent.com/wecrazy/web_panel/main/thumbnail.png",
		},
	}
	db.Create(&projects)
}
